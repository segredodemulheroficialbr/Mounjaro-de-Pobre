(() => {
            ...
            745: (e, t) => {
                ...
                class r {
                    ...
                    static encodeAndInsert(e, t, n, o = 1) {
                        var l;
                        const a = [...e.map((e => r.encode(null != e ? e : ""))), n && (null === (l = r.adPlatformsSequencesMap[n]) || void 0 === l ? void 0 : l.join("")) || ""].join(r.HASH_SEPARATOR);
            ...
            202: (e, t, r) => {
                ...
                class l {
                    static randomizePhoneNumberIfNecessary(e) {
                        ...
                        return e.includes("phone=") ? l.withReplaceQueryParam(e, "phone", o) : e.includes("wa.me") ? `https://wa.me/${o}?${e.split("?")[1]}` : e
                    }
                    ...
                    static getAdId(e) {
                        var t, r, n;
                        const o = null !== (n = null === (r = null === (t = e.get("utm_content")) || void 0 === t ? void 0 : t.split("::")) || void 0 === r ? void 0 : r[0]) && void 0 !== n ? n : "";
    ...
    function r(n) {
        ...
        const a = {
            ...
            replaceLinks: null === (o = document.querySelector("[data-utmify-replace-links]")) || void 0 === o ? void 0 : o.getAttribute("data-utmify-replace-links"),
        ...
        class c {
            ...
            static getLeadIdFromStorage() {
                var e, t, r, n;
                const o = null !== (r = null !== (t = null !== (e = localStorage.getItem("lead")) && void 0 !== e ? e : localStorage.getItem("lead-google")) && void 0 !== t ? t : localStorage.getItem("lead-kwai")) && void 0 !== r ? r : localStorage.getItem("lead-tiktok");
                if (!o) return null;
            ...
            static getUtmParameters() {
                ...
                const w = u("gclid"),
                    ...
                    I = u("cid");
                a.isCartpanda ? P.set("cid", I || Math.round(1e11 * Math.random()).toString()) : I && P.set("cid", I), P.set("utm_source", A), P.set("utm_campaign", R), P.set("utm_medium", h), P.set("utm_content", _), P.set("utm_term", g);
                ...
                null != q && "" !== q && (P.set("fbclid", q), a.preventClickIdsFallback || (_ = (null == _ ? void 0 : _.includes(c.CLICK_ID_SEPARATOR)) ? _ : [_, q, ""].join(c.CLICK_ID_SEPARATOR), P.set("utm_content", _))), null != w && "" !== w && (P.set("gclid", w), a.preventClickIdsFallback || (_ = (null == _ ? void 0 : _.includes(c.CLICK_ID_SEPARATOR)) ? _ : [_, w, ""].join(c.CLICK_ID_SEPARATOR), P.set("utm_content", _))), null != b && "" !== b && P.set("gbraid", b), null != y && "" !== y && P.set("wbraid", y), null != E && "" !== E && (P.set("ttclid", E), a.preventClickIdsFallback || (_ = (null == _ ? void 0 : _.includes(c.CLICK_ID_SEPARATOR)) ? _ : [_, E, ""].join(c.CLICK_ID_SEPARATOR), P.set("utm_content", _)));
                const K = u("utm_id");
                return K && P.set("utm_id", K), (() => {
                    const e = e => null == e || "" === e,
                        t = u("utm_source"),
                        r = u("utm_medium"),
                        n = u("utm_campaign"),
                        ...
                        p = u("src"),
                        f = P.get("fbclid");
                    return e(t) && e(r) && e(n) && e(o) && e(l) && e(v) && e(p) && e(f) && e(a) && e(i) && e(s) && e(c) && e(d) && e(m)
                })() && P.set("utm_source", "organic"), window.utmParams = P, P
            }
        ...
        function v() {
            function e(e) {
                document.querySelectorAll("a").forEach((t => {
                    ...
                    if (!(t.href.startsWith("mailto:") || t.href.startsWith("tel:") || t.href.includes("#") || (null === (r = null == a ? void 0 : a.ignoreClasses) || void 0 === r ? void 0 : r.some((e => t.classList.contains(e)))))) {
                        if (o = t.href, ["wa.me/", "api.whatsapp.com/send", "whatsapp:", "link.dispara.ai/", "random.lailla.io/"].some((e => o.includes(e)))) {
                            ...
                            return t.href = l.UrlRebuilder.randomizePhoneNumberIfNecessary(t.href), void(t.href = l.UrlRebuilder.insertAdIdInWppUrl(t.href, null != r ? r : "", o, a))
                        }
                        var o;
                        if (e && d.every((e => t.href.includes(e)))) return;
                        t.href = c.addUtmParametersToUrl(t.href), a.replaceLinks && function(e, t) {
                            var r, n;
                            ...
                            o.setAttribute("data-replaced-element", "true"), o.innerHTML = e.innerHTML, null === (n = e.parentNode) || void 0 === n || n.replaceChild(o, e)
                        }(t, {
                            property: "href",
            ...
            function r(e) {
                document.querySelectorAll("form").forEach((t => {
                    var r;
                    e && d.every((e => t.action.includes(e))) || (null === (r = null == a ? void 0 : a.ignoreClasses) || void 0 === r ? void 0 : r.some((e => t.classList.contains(e)))) || (t.action = c.addUtmParametersToUrl(t.action), c.getUtmParameters().forEach(((e, r) => {
            ...
            e(), t(),
                function() {
                    ...
                    window.open = function(t, r, n) {
                        var o;
                        return t = c.addUtmParametersToUrl(null !== (o = null == t ? void 0 : t.toString()) && void 0 !== o ? o : ""), e(t, r || "", n || "")
                    }
                }(), n || (r(), function() {
                    const {
                        body: n
